			...
			<div class="div_vendas_lucros fontesgeral fontes_topo">
				...
				<div  class="Lucros">
					...
					<div class="div_lucros">
						...
						<div class="circulo_lucros"> 
							<span class="chart" data-percent="50"></span>
							<div class="textos_circulo">
    					...
    					<div class="valor_lucros">
    						<div class="valor_lucros_reais">
    							<div class="digitos">R$ 1.000.00</div>
    							<div class="digitos">R$ 900.00</div>
    							<div class="digitos">R$ 300.00</div>
    						</div>
    						<div class="hrs_lucros">
    							<hr class="hrs">
    							<hr class="hrs">
    							<hr class="hrs">
    						</div>
    						<div class="periodo_lucros">
    							<div class="periodo">Dia</div>
    							<div class="periodo">Semana</div>
